...
<html>
    <head>
        ...
        <!-- Fav icon -->
			<link rel = "shortcut icon" href = "<?php echo SITE_PATH ?>view/img/favicon.ico" type = "image/ico"/>
        ...
        <script type="text/javascript" src="./view/inc/translate.js"></script>
		 ...
		 <!-- Scripts Plantilla START-->
			...
			<script src="module/contact/model/controllerContact.js"></script>
			<!-- <script src="view/js/ajax_promise/ajax_promise.js"></script> -->
			<script src="view/js/utils.inc.js"></script>
			<script type=”text/javascript” src=”view/js/toastr.js”></script>
